...
<xsl:template name="createheader">
   ...
   <div id="header" style="background-color:{$bgcolor}; width:100%; float:left; color:white; ">
      <div id="title" style="float:left; margin:0.5em; vertical-align:middle; font-size:1.2em; font-variant: small-caps; font-weight:bold; letter-spacing:1px; width:calc(100% - 8.5em);"> 
         <xsl:value-of select="title"/>
      </div>
      <div id="rolelevel" style="width: 13em; float:right; text-align:right; font-size: 0.8em; margin:0.5em; font-weight: bold;">
