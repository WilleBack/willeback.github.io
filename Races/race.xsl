...
<xsl:template match="/">
   ...
   <div id="classheader" style="box-sizing:border-box; width:100%; float:left; color:white; ">
      ...
      <div id="classinfo" style="background:linear-gradient(to right, #45494f, #45494f, #6d737c); box-sizing:border-box; width:100%; padding:1em; float:left;" >
         <b><xsl:text>Size: </xsl:text></b>  <xsl:value-of select="race/size" /> <xsl:text>; </xsl:text> <b><xsl:text>Origin: </xsl:text></b> <xsl:value-of select="race/origin" /> <br />
   ...
   <div class="container">
      ...
      <div class="feature">
         ...
         <div class="text">
            <xsl:text>The following are class features of the </xsl:text><xsl:value-of select="race/subname" /> <xsl:text> version of the </xsl:text> <xsl:value-of select="race/name" /> <xsl:text> class:</xsl:text>
         </div>
      </div>
