...
<xsl:template match="/">
	...
	<div id="classheader" style="box-sizing:border-box; width:100%; float:left; color:white; ">
		...
		<div id="subclasstitle" style="background-color:#042151; box-sizing:border-box; width:100%; float:left; font-size:1.2em; padding:0em 1em 1em; font-variant:small-caps; letter-spacing:1px;">
		...
		<xsl:for-each select="class/feature">
			...
			<xsl:if test="subfeature">
				<xsl:for-each select="subfeature">
					<div id="subfeature" style="width:100%; float:left; page-break-inside:avoid;">
